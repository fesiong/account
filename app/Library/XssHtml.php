...
class XssHtml
{
    ...
    private $m_xss;
    private $m_ok;
    private $m_AllowAttr = array('title', 'src', 'href', 'id', 'class', 'width', 'height', 'alt', 'target', 'align', 'color', 'size', 'colspan', 'rowspan', 'controls', 'autoplay', 'classid', 'codebase', 'name', 'value', 'quality', 'allowScriptAccess', 'pluginspage', 'type', 'data-type', 'data-id','frameborder', 'allowfullscreen');

    private $m_AllowTag = array('a', 'img', 'br', 'strong', 'b', 'code', 'pre', 'p', 'div', 'em', 'span', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'table', 'ul', 'ol', 'tr', 'th', 'td', 'hr', 'li', 'u' ,'del', 'blockquote', 'i', 'font', 'strike', 'dl', 'dt', 'dd', 'thead', 'tbody', 'audio', 'video', 'object', 'param', 'embed', 'iframe');
    /**
     * 构造函数
     *
    ...
    public function getHtml()
    {
        ...
        $html = preg_replace('/^\n(.*)\n$/s', '$1', $html);
        //删除最后一个<p><br/></p>
        $html = preg_replace('/<p>\s*<br\s*\/?>\s*<\/p>$/Uis', '$1', $html);
        return $html;
    }
