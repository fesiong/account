...
class Image
{
    ...
    public $option = IMAGE_CORE_OP_TO_FILE;

    public $scale;

    // clipping method 0: default 1: left or top 2: middle 3: right or bottom
    public $clipping = IMAGE_CORE_CM_MIDDLE;

    public $start_x = 0;	// start X axis (pixel)
    public $start_y = 0;    // start Y axis (pixel)
    public $source_image_w;
    public $source_image_h;
    public $source_image_x;
    public $source_image_y;
    ...
    public function resize()
    {
        ...
        {
            return 'Source file not exists: ' . $this->source_image;
        }
        ...
        {
            default:
                return 'Can\'t detect output image\'s type: ' . $this->source_image;
                break;
    ...
    private function imageProcessGD()
    {
        ...
        {
            return 'Function not exists for output: ' . $func_output;
        }
        ...
        {
            return 'Function not exists for output: ' . $func_create;
        }
        ...
        else if ($this->option == IMAGE_CORE_OP_OUTPUT)
        {
            ...
            {
                return 'HTTP already sent, can\'t output image to browser.';
            }
